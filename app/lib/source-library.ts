...
export const DEFAULT_SOURCES: SignalSource[] = [
  {
    ...
    type: "gdelt",
    url: gdeltUrl('India politics government election BJP Congress parliament protest court', 12, "1d"),
    region: "india",
    category: "Freshness / zero-token first pass",
    priority: 130,
    active: true,
  },
  {
    id: "fresh-gdelt-india-protest-24h",
    name: "Fresh 24h Protest + Courts",
    type: "gdelt",
    url: gdeltUrl('India protest students police court rights public order', 10, "1d"),
    region: "india",
    category: "Freshness / protest watch",
    priority: 129,
    active: true,
  },
  {
    id: "fresh-gdelt-party-election-24h",
    name: "Fresh 24h Party + Election",
    type: "gdelt",
    url: gdeltUrl('India BJP Congress AAP RJD JDU election bypoll candidate alliance', 10, "1d"),
    region: "india",
  ...
  {
    id: "rss-indian-express-political-pulse",
    name: "Indian Express Political Pulse",
    type: "rss",
    url: "https://indianexpress.com/section/political-pulse/feed/",
    region: "india",
    category: "Direct newsroom RSS / politics",
    priority: 127,
    active: true,
  },
  {
    id: "rss-indian-express-politics",
  ...
  {
    id: "rss-indian-express-india",
    name: "Indian Express India",
    type: "rss",
    url: "https://indianexpress.com/section/india/feed/",
    region: "india",
    category: "Direct newsroom RSS / national",
    priority: 125,
    active: true,
  },
  {
    id: "rss-ndtv-india-news",
    name: "NDTV India News RSS",
    type: "rss",
  ...
  {
    id: "rss-ndtv-latest",
    name: "NDTV Latest RSS",
    type: "rss",
    url: "https://feeds.feedburner.com/ndtvnews-latest",
    region: "india",
    category: "Direct newsroom RSS / latest",
    priority: 123,
    active: true,
  },
  {
    id: "rss-hindustan-times-india",
  ...
  {
    id: "rss-times-of-india-india",
    name: "Times of India India RSS",
    type: "rss",
    url: "https://timesofindia.indiatimes.com/rssfeed_India.cms",
    region: "india",
    category: "Direct newsroom RSS / national",
    priority: 120,
    active: true,
  ...
  {
    id: "google-news-fresh-politics-24h",
    name: "Google News Fresh India Politics 24h",
    type: "rss",
    url: googleNewsRss('India politics government election protest parliament court when:1d'),
    region: "india",
    category: "Freshness / Google News backup",
    priority: 118,
    active: true,
  },
  {
    id: "google-news-fresh-bjp-congress-24h",
    name: "Google News Fresh BJP Congress 24h",
    type: "rss",
    url: googleNewsRss('India BJP Congress AAP opposition election protest when:1d'),
    region: "india",
    category: "Freshness / party backup",
    priority: 117,
    active: true,
  },
  {
