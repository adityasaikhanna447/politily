...
const demoStory: StoredStory = {
  ...
  totalScore: 79,
  scoringBreakdown: {
    noveltySignals: ["Demo story compared against recent stored stories."],
    politicalSignals: ["election", "institutions", "campaign finance"],
    geopoliticalSignals: [],
    viralSignals: ["transparency", "public trust"],
    sentimentSignals: ["public accountability"],
    velocitySignal: "Demo mode: no live velocity.",
    sourceSignal: "Demo mode: one official source trail.",
    formula: "Total score = novelty 24%, political 31%, geo 20%, viral 25%.",
  },
  verificationMethod: "Demo: verify with Election Commission records, court material, and at least one independent source.",
  status: "briefed",
  brief: demoBrief,
  ...
  sourceLinks: [
    {
      ...
      biasLean: "state-owned",
      verificationMethod: "Primary official record lane.",
      sourceLane: "official",
      publishedAt: generatedAt,
