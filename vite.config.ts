...
const localBindingConfig = {
  ...
  vars: {
    ...
    POLITILY_MAX_EMAIL_ALERTS_PER_RUN: "0",
    POLITILY_MAX_SOURCES_PER_RUN: "4",
    POLITILY_MAX_SIGNALS_PER_RUN: "6",
    POLITILY_FETCH_TIMEOUT_MS: "5000",
    POLITILY_MIN_STORY_DATE: "2026-07-20T00:00:00+05:30",
    POLITILY_MAX_MEDIA_FETCHES_PER_RUN: "0",
    POLITILY_D1_MAX_ROWS_PER_JOB: "8000",
